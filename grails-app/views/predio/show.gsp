...
<html>
    ...
    <body>
        ...
        <div id="show-predio" class="content scaffold-show" role="main">
            ...
            <f:display bean="predio" />
            <g:form resource="${this.predio}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.predio}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
